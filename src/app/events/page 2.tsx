        ...
        <div className="section-shell page-gutter">
          ...
          <div className="mt-8 max-w-3xl border-t border-[var(--line-soft)] pt-6">
            <p className="text-sm leading-6 text-[#5e4d41]">
              Looking specifically for singing waiters in Glasgow or surprise
              singers anywhere in Scotland? We have a dedicated page explaining
              how the format works and where it fits best.
            </p>
            <Link href="/singing-waiters-scotland" className="btn-secondary mt-5">
              Explore Singing Waiters
            </Link>
          </div>
        </div>
      </section>
