      ...
      <section id="packages" className="bg-[var(--page-stone)] py-12 md:py-20">
        <div className="section-shell page-gutter">
          ...
          <div className="mt-10 pt-10 border-t border-[var(--line-soft)]">
            ...
            <article className="info-card p-5 md:p-6 flex flex-col">
              <h3 className="section-subheading text-[1.2rem]">See Surprise Singers</h3>
              <p className="section-copy mt-3 text-[0.88rem] leading-6 text-[#545454] flex-1">
                Surprise singers are treated as their own booking format rather
                than a weddings package. If that is the part you are interested
                in, head to the dedicated page for how it works, what it fits
                best and pricing.
              </p>
              <div className="mt-5 pt-4 border-t border-[var(--line-soft)]">
                <Link href="/singing-waiters-scotland" className="btn-secondary">
                  Go To Surprise Singers
                </Link>
              </div>
            </article>
          </div>
        ...
        <div className="section-shell page-gutter">
          ...
          <div className="mt-8 max-w-3xl border-t border-[var(--line-soft)] pt-6">
            <p className="text-sm leading-6 text-[#5e4d41]">
              If the main thing you want is a high-impact daytime reveal, our
              dedicated singing waiters page explains how surprise singers work
              for weddings in Glasgow and across Scotland.
            </p>
            <Link href="/singing-waiters-scotland" className="btn-secondary mt-5">
              Surprise Singers Guide
            </Link>
          </div>
        </div>
      </section>
